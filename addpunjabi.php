...
<body>
    ...
    <div id="main1">
        <div class="final">
            <h2>Punjabi Menu</h2><br><br>
            <div class="query">
                <form action="addpunjabi.php" method="post">
            ...
            ?>
                <br><br>
                <h3>Add Item</h3>
                <form action="addpunjabi.php" method="post" onsubmit="return valid()" id="form">
                    <div class="mb-3">
                ...
                ?>
                    <br><br>
                    <h3>Update Item</h3>
                    <form action="addpunjabi.php" method="post" onsubmit="return updatevalid()" id="form">
                        <div class="mb-3">
                ...
                ?>
                    <br><br>
                    <h3>Delete Item</h3>
                    <form action="addpunjabi.php" method="post" onsubmit="return devalid()" id="form">
                        <div class="mb-3">
